...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper } from './2-B7Uel2j3.js';
...
const lang_map = {
  python: () => import('./index29-oPuKhzUy.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index30-DG1vD2fh.js'),
      import('./frontmatter-DAPc4TQE.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index34-slVypJZz.js').then((m) => m.json()),
  html: () => import('./index31-CNwOHHIO.js').then((m) => m.html()),
  css: () => import('./index32-Bj6_n9rG.js').then((m) => m.css()),
  javascript: () => import('./index33-B072IoLw.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index33-B072IoLw.js').then(
...
//# sourceMappingURL=Index13-s5LXEL4_.js.map
